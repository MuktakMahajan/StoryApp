...
import {View,Text,Image,Button,TouchableOpacity, StatusBar, TouchableWithoutFeedback} from 'react-native';
import styles from './styles'
export default class Screen4 extends Component{
  renderFileUri(x) {
    if (x) {
      return <Image source={{ uri: x }} style={styles.images} />
    } else {
      return <Image source={require('./profile.jpg')} style={styles.images} />
    }
  }
  render() {
